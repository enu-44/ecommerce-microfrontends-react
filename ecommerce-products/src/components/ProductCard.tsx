...
export function ProductCard({ index, product }: Readonly<ProductCardProps>) {
    return (<div key={index} className="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white shadow-md duration-300 hover:scale-105 hover:shadow-lg">
        <Link to={`${product.id}`}>
